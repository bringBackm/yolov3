...
# Set Up Image Lists
paste <(awk '{print "/media/ros/0D1416760D141676/Documents/coco"}' <5k.part) 5k.part | tr -d '\t' > 5k.txt
paste <(awk '{print "/media/ros/0D1416760D141676/Documents/coco"}' <trainvalno5k.part) trainvalno5k.part | tr -d '\t' > trainvalno5k.txt
